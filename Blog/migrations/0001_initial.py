    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('thumbnail_alt', models.CharField(default='Thumbnail Görseli', max_length=125, verbose_name='Kapak Görseli Açıklaması')),
                ('thumbnail_owner', models.CharField(blank=True, max_length=64, null=True, verbose_name='Kapak Görseli Sahibi')),
